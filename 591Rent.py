...
# 租屋頁首頁抓取
res = requests.get('https://rent.591.com.tw/?kind=0&region=6', headers = headers)

# 租屋頁第二頁抓取
res = requests.get('https://rent.591.com.tw/home/search/rsList?is_new_list=1&type=1&kind=0&searchtype=1&region=3&firstRow=30&totalRows=8954', headers = headers)
# print(res.text)
